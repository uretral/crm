...
class Field implements Renderable
{
    ...
    const TPL_PARENT_TAG = 'new___PARENT_KEY__';
     ...
     * @return mixed|string
     */
    public function setElementNameFlat($parentName, $replace)
    {
        $pos = strpos($this->elementName, $parentName);
        $this->elementName = $pos!==false ? substr_replace($this->elementName, $replace, $pos, strlen($parentName)) : $this->elementName;

        return $this;
    }

//    public function setElementNameFlatParent($name, $replace = 'new___PARENT_KEY__')
//    {
//        $pos = strpos($this->elementName, '#[0-9]+#');
//        $this->elementName = $pos!==false ? substr_replace($this->elementName, $replace, $pos, strlen($name)) : $this->elementName;
//
//        return $this;
//    }
