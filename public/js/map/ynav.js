        ...
        case Yours.status.routeFinished:
            ...
            for (i = 0; i < MyFirstRoute.Segments.length; i++) {
                ...
                if (MyFirstSegment.distance === undefined) {
                    ...
                    seg_div.append("length = "+MyFirstSegment.distance.toFixed(2)+" km, traveltime = "+MyFirstSegment.traveltime+" sec, nodes = "+MyFirstSegment.nodes);
                }
            ...
            seg_li = $(document.createElement("li"));
            seg_ul.append(seg_li);
            seg_li.append("Traveltime = "+MyFirstRoute.traveltime+" sec");
