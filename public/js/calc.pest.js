...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Calc_CalcPest__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Calc_CalcPest___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_Calc_CalcPest__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('CalcPest', __WEBPACK_IMPORTED_MODULE_2__components_Calc_CalcPest___default.a);
...
Component.options.__file = "resources/js/components/Calc/CalcPest.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cccfea6c", Component.options)
  } else {
    hotAPI.reload("data-v-cccfea6c", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        save: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(field, value, id) {
                var response;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/ajax/price/save_field?pest=' + this.pest.id + '&id=' + id + '&field=' + field + '&value=' + value);
        ...
        addRemedy: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(method) {
                var response;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.prev = 0;
                                _context2.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/ajax/price/add_remedy?method=' + method + '&pest=' + this.pest.id);
            ...
            function addRemedy(_x4) {
                return _ref2.apply(this, arguments);
            }

            return addRemedy;
        }(),
        removeRemedy: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(rowID) {
                var response;
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.prev = 0;
                                _context3.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/ajax/price/remove_remedy?id=' + rowID);
            ...
            function removeRemedy(_x5) {
                return _ref3.apply(this, arguments);
            }

            return removeRemedy;
        }(),
        calcPrice: function calcPrice(remedy, exp) {
            var r = this.chemicals[remedy.remedy];
            var cost = r.price_net / 1000 * r.expenses * exp;
...
var render = function() {
  ...
  return _c("div", { staticClass: "Pest" }, [
    _c("h2", [_vm._v(_vm._s(_vm.pest.name))]),
    _vm._v(" "),
    _c("table", { staticClass: "pest-tbl" }, [
      _vm._m(0),
      _vm._v(" "),
      _c(
        "tbody",
        _vm._l(_vm.price, function(method, methodKey) {
          return _c("tr", [
            _c("td", [
              _vm._v(
                "\n                " +
                  _vm._s(_vm.methods[methodKey].name) +
                  "(" +
                  _vm._s(methodKey) +
                  ")\n            "
              )
                  ...
                  "btn",
                  {
                    on: {
                      click: function($event) {
                        return _vm.addRemedy(methodKey)
                      }
                    }
                  },
                  [_vm._v("+")]
            ...
            _c("td", { attrs: { colspan: "3" } }, [
              _c(
                ...
                [
                  ...
                  _c(
                    "tbody",
                    _vm._l(method, function(remedy, remedyKey) {
                      return _c("tr", [
                        _c(
                          "td",
                          ...
                          [
                            _c(
                              "btn",
                              {
                                on: {
                                  click: function($event) {
                                    return _vm.removeRemedy(remedy.id)
                                  }
                                }
                              },
                              [_vm._v("-")]
                        ...
                        _c("td", [
                          _c(
                            ...
                            _vm._l(_vm.chemicals, function(chemical) {
                              return _c(
                                "option",
                                { domProps: { value: chemical.id } },
                                [_vm._v(_vm._s(chemical.name))]
                              )
                            }),
                            0
                          )
                        ...
                        _c(
                          "td",
                          [
                            _vm.chemicals[remedyKey] !== undefined
                              ? [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(
                                        _vm.chemicals[remedyKey].expenses
                                      ) +
                                      "\n                            "
                                  )
                                ]
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: remedy.expenses,
                                        expression: "remedy.expenses"
                                      }
                                    ],
                                    attrs: { type: "number" },
                                    domProps: { value: remedy.expenses },
                                    on: {
                            ...
                            _vm.chemicals[remedyKey] !== undefined
                              ? [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(
                                        _vm.chemicals[remedyKey].price_net
                                      ) +
                                      "\n                            "
                                  )
                                ]
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { attrs: { colspan: "2" } }, [_vm._v("Метод :  ")]),
        _vm._v(" "),
        _c("th")
      ])
    ])
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { attrs: { colspan: "2" } }, [_vm._v("Средство : ")]),
        _vm._v(" "),
        _c("th", [_vm._v("расход (л)")]),
        _vm._v(" "),
        _c("th", [_vm._v(" (м²)")]),
        _vm._v(" "),
        _c("th", [_vm._v("Закуп  (1л/кг)")]),
        _vm._v(" "),
        _c("th", [_vm._v("с/c (м²/сотка)")])
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cccfea6c", module.exports)
  }
}
...
var update = __webpack_require__(16)("8260719c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-cccfea6c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CalcPest.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-cccfea6c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CalcPest.vue");
